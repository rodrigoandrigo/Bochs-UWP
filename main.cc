...
#if !defined(__WXMSW__) && !defined(BX_UWP_CORE_LIBRARY)
...
#ifdef BX_UWP_CORE_LIBRARY
      strncpy_s(bx_startup_flags.initial_dir, bochsrc_filename, _TRUNCATE);
      length = (int) strlen(bx_startup_flags.initial_dir);
#else
