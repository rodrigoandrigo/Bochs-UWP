...
namespace UWP_Port
{
	...
	public:
		...
		static concurrency::task<Platform::String^> CreateConfigAsync(
			Platform::String^ diskPath,
			Platform::String^ disk2Path,
			Platform::String^ floppyPath,
			Platform::String^ floppyBPath,
			Platform::String^ cdromPath,
			Platform::String^ cdrom2Path,
			Platform::String^ sharedFolderPath,
			Platform::String^ bootTarget,
			int memoryMb,
			Platform::String^ cpuModel,
			...
			Platform::String^ vgaBiosPath,
			bool soundEnabled,
			Platform::String^ networkAdapter,
			Platform::String^ diskImageMode,
			Platform::String^ disk2ImageMode,
			Platform::String^ usbController,
			Platform::String^ usbDevice,
			Platform::String^ usbImagePath,
			Platform::String^ serialMode,
			bool parallelEnabled,
			Platform::String^ videoExtension,
			int videoUpdateFreq,
			bool videoRealtime,
			int vbeMemoryMb,
			Platform::String^ displayLibrary,
			int rfbTimeout,
			int networkSocketPort,
			Platform::String^ pciChipset,
			bool acpiEnabled,
			bool hpetEnabled,
			bool ioApicEnabled);
